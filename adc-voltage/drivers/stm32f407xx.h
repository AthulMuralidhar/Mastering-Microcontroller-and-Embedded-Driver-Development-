 ...
 */
#define GPIOA  				((GPIO_RegDef_t*)GPIOA_BASEADDR) /*!< Pointer to GPIO Port A 0x1400)registers */
...
typedef struct
{
  __vo uint32_t CSR;     /*!< ADC Common status register,               Address offset: ADC base + 0x00 */
  __vo uint32_t CCR;     /*!< ADC common control register,              Address offset: ADC base + 0x04 */
  __vo uint32_t CDR;     /*!< ADC common regular data register for dual, Address offset: ADC base + 0x08 */
} ADC_Common_RegDef_t;
